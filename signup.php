...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Indie+Flower&family=Syne+Mono&family=Tangerine:wght@700&display=swap" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Indie+Flower&family=Syne+Mono&family=Tangerine:wght@700&family=VT323&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <div class="main">
           <div class="signup_form">
               <h2>Sign Up</h2>
               <form id="sign_form" action = "includes/signup.inc.php" method="post">
                    <h3>Landlord:</h3>
                   ...
                   <div class="input-control">
                        <input id="mobilenumber" type="tel" name="mobilenumber" placeholder="Mobile Number (07...)" >
                        <div class="error"></div>
                   </div>
                   <div class="input-control">
                        <input id="userpassword" type="password" name="UserPassword" placeholder="Password..." id="password">
                        <div class="error"></div>
                   </div>
                   <div class="input-control">
